...
- También podemos saber que objetos **no** le gusta a una persona. A Estefanía **no** le gusta: una _pelota_ parda de cuero, un _muñeco_ celeste de vidrio o una _placa_ de cobre de color pardo.
...
Se espera que el objeto que representa al bolichito responda a estos mensajes:
